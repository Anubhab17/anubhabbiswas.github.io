...
permalink: /publication/2025-07-30-geometry-nonlinear-reconciliation
excerpt: 'This paper presents a theoretical framework for nonlinear forecast reconciliation based on local curvature and projection geometry.'
date: 2026-01-13
venue: 'Transactions on Machine Learning Research'
paperurl: 'https://openreview.net/forum?id=dXRWuogm3J'
citation: 'Nespoli, L., Biswas, A., Rocchetta, R., & Medici, V. (2026). Nonlinear reconciliation: Error reduction theorems. Transactions on Machine Learning Research." </i>https://openreview.net/forum?id=dXRWuogm3J</i>.'
...
Read the full paper on [TMLR](https://openreview.net/forum?id=dXRWuogm3J).
